...
[![R-CMD-check](https://github.com/KingSSIBAL/OneMeanDream/workflows/R-CMD-check/badge.svg)](https://github.com/KingSSIBAL/OneMeanDream/actions)
<!-- badges: end -->

## Overview

**OneMeanDream** provides enhanced one-sample t-test functionality with
advanced statistical approximations and comprehensive diagnostics:

- 📊 **Wallace Critical Value Approximation** for accurate hypothesis
  testing
- 🔬 **Hastings P-Value Approximation** for computational efficiency  
- ✅ **Comprehensive Assumption Checking** (Shapiro-Wilk normality test,
  outlier detection)
- 📈 **Diagnostic Plots** (Q-Q plot, histogram with normal curve
  overlay, boxplot)

## Installation

You can install the development version of OneMeanDream from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("KingSSIBAL/OneMeanDream")
```
...
Uses the Wallace approximation formula for converting z-values to
t-distribution critical values:

$$t_\alpha = \sqrt{\nu \left(e^{c \cdot z_\alpha^2 / \nu} - 1\right)}$$
...
Implements an efficient 4-term Hastings approximation for computing
p-values without relying on built-in distribution functions, ensuring
...
1.  **Normality Testing**: Shapiro-Wilk test with clear pass/fail
    indication
2.  **Outlier Detection**: Uses 1.5 × IQR rule to identify potential
    outliers
3.  **Visual Diagnostics**: Generates three diagnostic plots:
...
- [Getting Started
  Guide](https://kingssibal.github.io/OneMeanDream/articles/introduction.html)
- [Function
  Reference](https://kingssibal.github.io/OneMeanDream/reference/index.html)
- [Report Issues](https://github.com/KingSSIBAL/OneMeanDream/issues)

## Authors

Developed by the STAT 181 Team: Arianna Tagulinao, Cindy Barcena,
Francesca Anne Baclig, Josiah Tan, Junel Rey, Keano Pastrana, Matt
Andrei Miclat, Mica Gonzales, Zan Eros Policarpio, and Reijel Agub
(Maintainer)
