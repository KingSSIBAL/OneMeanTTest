...
You can install the development version of OneMeanDream from [GitHub](https://github.com/) with:
...
1. **Normality Testing**: Shapiro-Wilk test with clear pass/fail indication
2. **Outlier Detection**: Uses 1.5 × IQR rule to identify potential outliers
...
- [Getting Started Guide](https://kingssibal.github.io/OneMeanDream/articles/introduction.html)
- [Function Reference](https://kingssibal.github.io/OneMeanDream/reference/index.html)
- [Report Issues](https://github.com/KingSSIBAL/OneMeanDream/issues)

## Authors

Developed by the STAT 181 Team:
Arianna Tagulinao, Cindy Barcena, Francesca Anne Baclig, Josiah Tan, Junel Rey, Keano Pastrana, Matt Andrei Miclat, Mica Gonzales, Zan Eros Policarpio, and Reijel Agub (Maintainer)
